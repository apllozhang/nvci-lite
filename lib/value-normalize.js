...
const UNIT_CANONICAL = { tbps: 'tbit/s', gbps: 'gbit/s', mbps: 'mbit/s', kbps: 'kbit/s', watts: 'w',
  'tb/s': 'tbit/s', 'gb/s': 'gbit/s', 'mb/s': 'mbit/s', 'kb/s': 'kbit/s' };
...
const KEY_SYNONYMS = {
  ...
  idle_power: 'power_static', static_power: 'power_static',
  max_power: 'power_max', full_load_power: 'power_max',
  expansion_slot: 'expansion_slots', uplink_slots: 'expansion_slots',
  os: 'os_version', software_os: 'os_version',
  max_rate: 'max_speed', top_speed: 'max_speed',
  product_position: 'positioning', scenario: 'positioning',
};
